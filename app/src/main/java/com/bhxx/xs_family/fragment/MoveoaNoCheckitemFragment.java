...
public class MoveoaNoCheckitemFragment extends BaseFragment {
    @InjectAll
    private Views v;
    int type;
     ...
     * @return
     */
    public static MoveoaNoCheckitemFragment getInstance(int type) {
        MoveoaNoCheckitemFragment fragment = new MoveoaNoCheckitemFragment();
    ...
    private class MyPageAdapter extends FragmentPagerAdapter {
        ...
        public MyPageAdapter(FragmentManager fm) {
            super(fm);
            MoveoaNoCheckOneFragment fragmentone = new MoveoaNoCheckOneFragment();
            MoveoaNoCheckTwoFragment fragmenttwo = new MoveoaNoCheckTwoFragment();
            MoveoaNoCheckThreeFragment fragmentthree = new MoveoaNoCheckThreeFragment();
