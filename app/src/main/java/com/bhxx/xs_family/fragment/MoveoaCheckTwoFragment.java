...
public class MoveoaCheckTwoFragment extends BaseFragment {
        ...
        public void onResponse(String response, int id) {
            ...
            if (!TextUtils.isEmpty(response)) {
                ...
                if (listBean.getRows() != null && listBean.getRows().size() > 0) {
                    if (adapter == null) {
                        adapter = new MoveoaCheckwpAdapter(listBean.getRows(), getActivity(), R.layout.moveoawp_check_item,"check");
