...
public class ParentMyActItemFragment extends LazyLoadFragment {
    ...
    private void initActList() {
        ...
        params.put("acConditionState", String.valueOf(type));
        params.put("page", page + "");
        params.put("pageSize", GlobalValues.PAGE_SIZE);
        String taoken = TokenUtils.getInstance().configParams(GlobalValues.PARENT_MYACT + "?", params);
        params.put("taoken", taoken);
        MyOkHttp.postMap(GlobalValues.PARENT_MYACT, "PARENT_MYACT", params, new MyStringCallback());
    }
     ...
     * @return
     */
    public static ParentMyActItemFragment getInstance(int type) {
        ParentMyActItemFragment fragment = new ParentMyActItemFragment();
    ...
    protected void lazyLoad() {
        ...
        String taoken = TokenUtils.getInstance().configParams(GlobalValues.PARENT_MYACT + "?", params);
        params.put("taoken", taoken);
        MyOkHttp.postMap(GlobalValues.PARENT_MYACT, "PARENT_MYACT", params, new MyLoadCallback());
    }
