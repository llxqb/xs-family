...
public class MoveoaCheckThreeFragment extends BaseFragment {
        ...
        public void onResponse(String response, int id) {
            ...
            if (!TextUtils.isEmpty(response)) {
                ...
                if (listBean.getRows() != null && listBean.getRows().size() > 0) {
                    if (adapter == null) {
                        adapter = new MoveoaCheckfyAdapter(listBean.getRows(), getActivity(), R.layout.moveoafy_check_item,"check");
