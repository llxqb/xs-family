...
public class LoadImage {
    ...
    public static DisplayImageOptions getDefaultOptions() {
        ...
        Builder b = new Builder();
        /** 图片为空时，设置图片 */
        b.showImageForEmptyUri(R.mipmap.image_default_progress);
        /** 查不到图片时，设置图�? */
        b.showImageOnFail(R.mipmap.image_default_progress);
        /** 设置图片在下载期间显示的图片 */
        b.showImageOnLoading(R.mipmap.image_default_progress);
        /** 设置图片在下载前是否重置，复�? */
        b.resetViewBeforeLoading(Boolean.TRUE);
        /** 设置下载的图片是否缓存在SD卡中 */
