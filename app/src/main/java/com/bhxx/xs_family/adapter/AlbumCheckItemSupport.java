...
public class AlbumCheckItemSupport implements MultiTypeSupport<AlbumModel> {
    ...
    public int getLayoutId(int viewType) {
        switch (viewType) {
            case ITEM_TYPE_NO_PIC:
                return R.layout.album_check_no_pic_item;
            case ITEM_TYPE_SING_PIC:
                return R.layout.album_check_single_pic_item;
            case ITEM_TYPE_DOUBLE_PIC:
                return R.layout.album_check_double_pic_item;
            case ITEM_TYPE_LIST_PICS:
                return R.layout.album_check_list_pics_item;
            default:
                break;
        }
        return 0;
